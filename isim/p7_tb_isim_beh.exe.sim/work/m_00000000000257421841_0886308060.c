...
#endif
static const char *ng0 = "K:/Users/mobai/Desktop/ise/p7project/ALU.v";
...
LAB15:    xsi_set_current_line(17, ng0);
    ...
    *((unsigned int *)t3) = (t18 & 31U);
    memset(t38, 0, 8);
    xsi_vlog_unsigned_lshift(t38, 32, t4, 32, t10, 5);
    t9 = (t0 + 1768);
    xsi_vlogvar_assign_value(t9, t38, 0, 0, 32);
    goto LAB33;
...
LAB19:    xsi_set_current_line(19, ng0);
    ...
    *((unsigned int *)t3) = (t18 & 31U);
    memset(t38, 0, 8);
    xsi_vlog_unsigned_rshift(t38, 32, t4, 32, t10, 5);
    t9 = (t0 + 1768);
    xsi_vlogvar_assign_value(t9, t38, 0, 0, 32);
    goto LAB33;
...
LAB21:    xsi_set_current_line(20, ng0);
    ...
    *((unsigned int *)t3) = t16;
    t17 = *((unsigned int *)t38);
    *((unsigned int *)t38) = (t17 & 31U);
    t18 = *((unsigned int *)t3);
    *((unsigned int *)t3) = (t18 & 31U);
    memset(t39, 0, 8);
    xsi_vlog_signed_arith_rshift(t39, 32, t4, 32, t38, 5);
    t9 = (t0 + 1768);
    xsi_vlogvar_assign_value(t9, t39, 0, 0, 32);
    goto LAB33;
...
LAB29:    xsi_set_current_line(24, ng0);
    ...
    t4 = *((char **)t3);
    t3 = ((char*)((ng1)));
    xsi_vlogtype_concat(t50, 33, 33, 2U, t3, 1, t4, 32);
    t7 = (t0 + 1368U);
    t8 = *((char **)t7);
    t7 = ((char*)((ng1)));
    xsi_vlogtype_concat(t51, 33, 33, 2U, t7, 1, t8, 32);
    xsi_vlog_unsigned_less(t52, 33, t50, 33, t51, 33);
    memset(t38, 0, 8);
    t9 = (t52 + 4);
    t11 = *((unsigned int *)t9);
    t12 = (~(t11));
...
LAB40:    t21 = *((unsigned int *)t10);
    ...
    *((unsigned int *)t10) = (t42 & t35);
    t43 = *((unsigned int *)t10);
    *((unsigned int *)t10) = (t43 & t36);
    goto LAB42;

LAB43:    t21 = *((unsigned int *)t38);
    t22 = *((unsigned int *)t9);
    *((unsigned int *)t38) = (t21 | t22);
    t14 = (t4 + 4);
    t15 = (t7 + 4);
...
LAB56:    xsi_vlog_unsigned_bit_combine(t10, 32, t14, 32, t15, 32);
    goto LAB60;

LAB58:    memcpy(t10, t14, 8);
    goto LAB60;
...
extern void work_m_00000000000257421841_0886308060_init()
{
	static char *pe[] = {(void *)Always_10_0};
	xsi_register_didat("work_m_00000000000257421841_0886308060", "isim/p7_tb_isim_beh.exe.sim/work/m_00000000000257421841_0886308060.didat");
